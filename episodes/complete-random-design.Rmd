...
for all 522 data points in the group, then sum up the areas of all the boxes. 
Repeat the process with the other two groups, then add all of the sums 
($\sum\sum$) together. This used to be a manual process. Fortunately R does all 
of this labor for us.
