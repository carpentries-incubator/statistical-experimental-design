...
You would need 
`r round(power.t.test(delta = meanDiff, sd = sd(heart_rate$heart_rate), sig.level = 0.05, type = "two.sample", power = .8)$n)` participants per group to
...
>>>>>>> 6cc7f8f1261b32eb62db55265c427b08e12aaed4
