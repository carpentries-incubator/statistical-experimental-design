...
`r round(anova(lm(Delta ~ DrugDose + Exercise + DrugDose*Exercise, data = drugExercise))[3, 4], 2)`
on 
...
`r round(anova(lm(Delta ~ DrugDose + Exercise + DrugDose*Exercise, data = drugExercise))[2, 4], 2)`
on 
...
`r round(anova(lm(Delta ~ DrugDose + Exercise + DrugDose*Exercise, data = drugExercise))[1, 4], 2)`
